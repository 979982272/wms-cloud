...
$.core = {
    ...
    }, refreshTreeView: function (gridName) {
        // $("#" + gridName).data("kendoTreeView").dataSource.read();
        // $("#" + gridName).data("kendoTreeView").refresh()
    },
    ...
    _addToken: function (url) {
        ...
        return url + prefix + "token=" + $.core.data("token");
    }
};
